...
import exampleImage from 'figma:asset/3589e6bfa99d9c42e8639aa3a64bace4ae749046.png';
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          >
            ...
            <div className="flex gap-4">
              <a 
                href="https://instagram.com/waltcardetaily" 
                target="_blank" 
                rel="noopener noreferrer"
                className="w-10 h-10 bg-gradient-to-r from-[#E4405F] to-[#C13584] rounded-lg flex items-center justify-center hover:scale-110 transition-transform duration-300"
              >
